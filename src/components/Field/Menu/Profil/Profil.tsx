...
export const Profil = () => {
	return (
		<div className="Profil">
			...
			<p>
				Nechte si spočítat optimální výši nájmu. Díky rostoucí inflaci a neustále se zvyšujících cenách
				veškerých stavebních materiálů stávající výše nájmu už nemusí být aktuální.
			</p>
			<div className="Yangs__Header">Asistence při prodeji nemovitosti</div>
			<p>Asistence při koupi nebo prodeji nemovitosti (jak naaranžovat, nafotit, kde inzerovat...)</p>
