...
export const Yangs = () => {
	return (
		<div className="Yangs">
			...
			<p className="Yangs__Item">
				Bytový dům (do 2 bytových jednotek včetně) - <strong>6999</strong> Kč/odhad{" "}
			</p>
			<p className="Yangs__Item">
				Bytový dům (nad 2 bytové jednotky) - <strong>6999</strong> Kč/odhad + každá další bytová jednotka +
				1500Kč
			</p>
			<p className="Yangs__Item">
			...
			<u>
				<div className="Yangs__Header">Pozemky (dle velikosti, záleží na domluvě)</div>
			</u>
			<p className="Yangs__Item">
