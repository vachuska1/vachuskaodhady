	...
	return (
		<div className="Estimates Estimates__HeadText">
			...
			<div className="Estimates__Content">
				...
				<p>Odhad provádíme na území celé ČR, upřednosťujeme Plzeňský a Jihočeský kraj.</p>
				<br />
				<a href="/odhady"></a>
				<div className="Estimates__HeadText">Potřebujete odhad</div>
				<p>Můžete mě kontaktovat přes niže umístěný formulář, odpověď zašlu do 24 hodin.</p>
				<p>Nebo jsem dostupný též na telefonním čísle 774104020 a emailové adrese odhadyvachuska@gmail.com</p>
				<Inputs />
				<br />
